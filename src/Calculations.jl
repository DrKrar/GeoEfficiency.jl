...
function GeoEff_Disk(detector::CylDetector, SurfacePnt::Point, SrcRadius::Real)
	(detector.CryRadius > SurfacePnt.Rho + SrcRadius) || warn("GeoEff_Disk: Off the detector face sources is not supported yet $(detector.CryRadius > SurfacePnt.Rho + SrcRadius)")
